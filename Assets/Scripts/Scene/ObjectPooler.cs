...
public class ObjectPooler : MonoBehaviour
{
    ...
    public GameObject SpawnFromPool(string tag, Vector3 position, Quaternion rotation, bool canSpawn)
    {
        ...
        var block = objToSpawn.GetComponent<Block>();

        if (block != null)
        {
            block.setIfCanSpawn(canSpawn);
        }
